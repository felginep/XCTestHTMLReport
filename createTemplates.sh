...
designReviewScreenshot=`cat Sources/XCTestHTMLReport/HTML/design_review_screenshot.html | sed 's,",\\\\",g'`
testDesignReview=`cat Sources/XCTestHTMLReport/HTML/test_design_review.html | sed 's,",\\\\",g'`
testDesignReviewActivity=`cat Sources/XCTestHTMLReport/HTML/test_design_review_activity.html | sed 's,",\\\\",g'`
